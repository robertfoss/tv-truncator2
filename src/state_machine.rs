...
pub enum ProcessingState {
    ...
    Extracting { frames_processed: usize, frames_total: usize },
    
    /// Frame extraction complete
    Extracted { frames_processed: usize, frames_total: usize },
    
    /// Analyzing extracted frames for patterns
    Analyzing { frames_analyzed: usize, frames_total: usize },
    
    /// Frame analysis complete
    Analyzed { frames_analyzed: usize, frames_total: usize },
